...
def load_data(filename="commentsV1.csv", vocabulary_size=20000, min_sent_characters=0):
    ...
    #sentences = itertools.chain(*[nltk.sent_tokenize(x.lower()) for x in saved_column])
    # Filter sentences
